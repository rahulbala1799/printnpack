        ...
        <div className="flex flex-col-reverse md:flex-row items-center py-8 md:py-24">
          ...
          <div className="md:w-1/2 text-white z-10 space-y-4 md:space-y-6 mt-6 md:mt-0 text-center md:text-left w-full">
            <div className="animate-fade-in">
              ...
              <div className="inline-flex items-center mb-3 bg-red-950/90 backdrop-blur-sm rounded-lg py-1.5 px-3">
              ...
              <div className="mt-4 md:mt-6 flex flex-col sm:flex-row gap-2 md:gap-4 justify-center md:justify-start">
                ...
                <a href="tel:+353894157369" className="inline-flex items-center justify-center px-4 py-2 md:px-5 md:py-3 border border-white text-sm md:text-base font-medium rounded-md text-white hover:bg-white/10 transition transform hover:scale-105 duration-200">
              ...
              <div className="flex flex-wrap gap-1.5 mt-4 animate-fade-in-delayed justify-center md:justify-start">
                <span className="bg-red-900/90 text-white px-2 py-0.5 rounded-full text-xs md:text-sm">🇮🇪 Irish</span>
                {(currentSlide === 1 || currentSlide === 3 || currentSlide === 4) && (
                  <span className="bg-black text-white px-2 py-0.5 rounded-full text-xs md:text-sm font-bold">⚡ SAME-DAY</span>
                )}
                <span className="bg-red-900/90 text-white px-2 py-0.5 rounded-full text-xs md:text-sm">💰 Low MOQs</span>
                <span className="hidden md:inline-block bg-red-900/90 md:bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm">🌿 Locally Sourced</span>
                <span className="hidden md:inline-block bg-red-900/90 md:bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm">💰 No Hidden Costs</span>
              </div>
            </div>
          </div>
