...
const guides = [
  ...
  {
    href: '/clothing-faq-ireland',
    title: 'Clothing FAQ',
    description: 'Promotional wear, embroidery, MOQ and delivery answers.',
    image: '/images/apparel/POLO SHIRT MOCK UP 1.jpg',
    cta: 'Browse FAQ',
  },
  {
    href: '/blog/branded-clothing-ireland-guide',
    title: 'Branded Clothing Guide',
    description: 'Promotional vs corporate clothing, print vs embroidery.',
    image: '/images/apparel/HOODIE MOCK UP 1.jpg',
    cta: 'Read the guide',
  },
  {
    href: '/posters',
    title: 'Poster Printing Ireland',
    description: 'Custom poster prints A4–A0 from €8, no minimum order.',
  ...
  },
  {
    ...
    description: 'Sizes, 170gsm vs 200gsm, cost and turnaround.',
