      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-gray-500">Our best-selling products</p>
          </div>
          <Link
            href="/products"
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-square bg-gradient-to-br from-blue-50 to-indigo-50 overflow-hidden">
                  ...
                  {/* Category tag */}
                  <span className="absolute top-2 left-2 text-xs font-medium bg-white/90 backdrop-blur-sm text-gray-600 px-2 py-0.5 rounded-md">
                    {product.category}
                  </span>
                </div>
