        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/foamex-boards" className="hover:text-blue-300">Foamex Boards</Link></li>
              <li><Link href="/correx-boards" className="hover:text-blue-300">Correx Boards</Link></li>
              <li><Link href="/vinyl-stickers" className="hover:text-blue-300">Vinyl Stickers</Link></li>
              <li><Link href="/roll-up-banners" className="hover:text-blue-300">Roll Up Banners</Link></li>
