...
export default function FlagQuoteModal({ isOpen, onClose, config }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm, setSubmitting }) => {
      try {
        const configSummary = formatFlagQuoteSummary(config);
...
Submitted from the Custom Printed Flags Ireland quote builder.`;
        ...
        const response = await fetch('/api/contact', {
          ...
          body: JSON.stringify({
            ...
            message,
            productInterest: 'Custom Printed Flags Quote Request',
            source: 'Flag Quote Builder',
          }),
        });
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="flag-quote-modal-title"
      >
        <div className="sticky top-0 bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between rounded-t-2xl z-10">
          <h2 id="flag-quote-modal-title" className="text-lg font-bold text-slate-900">
            Request a flag quote
          </h2>
          <button
            type="button"
            onClick={() => onClose()}
        ...
        <div className="px-6 py-5">
            ...
            <dl className="space-y-2 text-sm">
              ...
              <div className="flex justify-between gap-4">
                ...
                <dd className="text-slate-900 font-medium text-right">
                  ...
                  {selectedMaterial?.gsm ? ` (${selectedMaterial.gsm})` : ''}
                </dd>
              </div>
              <div className="flex justify-between gap-4">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="flag-quote-name" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div>
              <label htmlFor="flag-quote-email" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="flag-quote-phone" className="block text-sm font-medium text-slate-700 mb-1">
                  Phone
                </label>
                <div className="relative">
              ...
              <div>
                <label htmlFor="flag-quote-company" className="block text-sm font-medium text-slate-700 mb-1">
                  Company / Club
                </label>
                <div className="relative">
                  <FaBuilding className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm" />
                  <input
                    id="flag-quote-company"
                    name="company"
                    type="text"
            ...
            <div>
              <label htmlFor="flag-quote-notes" className="block text-sm font-medium text-slate-700 mb-1">
                Additional notes
              </label>
              <textarea
                id="flag-quote-notes"
