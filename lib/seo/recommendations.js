...
const QUERY_PAGE_MAP = [
  ...
  { patterns: [/extra wide roll/i, /xl roll up/i, /xl roller banner/i, /2m roll up/i, /200cm roll up/i, /wide format roll up/i, /large pull up banner/i], page: '/extra-wide-roll-up-banners-ireland', action: 'optimize' },
