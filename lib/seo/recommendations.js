...
const QUERY_PAGE_MAP = [
  { patterns: [/decal/i, /trade show banner/i], page: '/blog/trade-show-banners-decals-ireland', action: 'optimize' },
  ...
  { patterns: [/flat handle.*bag/i, /paper bag/i], page: '/blog/paper-bags-with-logo-ireland', action: 'optimize' },
