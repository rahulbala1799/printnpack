...
const QUERY_PAGE_MAP = [
  ...
  { patterns: [/printing services near me/i, /printing services/i, /print shop near me/i], page: '/printing-ireland', action: 'optimize' },
  ...
  { patterns: [/sealer bar/i, /heat sealer/i], page: '/plain-packaging/220021', action: 'optimize' },
