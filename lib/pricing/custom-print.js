...
export function calculatePrintedPizzaBox(params, rules = {}, plainMaterial = null) {
  ...
  const plainCaseFields = {
    plain_price_per_case_ex: plainMaterial?.pricePerCase ?? null,
    plain_units_per_case: plainMaterial?.unitsPerCase ?? null,
    plain_case_label: plainMaterial?.caseLabel ?? plainProduct?.case_label ?? null,
...
export function calculatePlainPackagingPrinted(family, params, rules = {}, plainMaterial = null, globalRules = {}) {
  ...
  const categoryMap = {
    ...
    corrugated_meal_box_printed: 'Corrugated Meal Box',
...
export function calculateCustomProduct(family, params, rulesRows = [], plainMaterial = null, globalRulesRows = []) {
  ...
  switch (family) {
    ...
    case 'corrugated_meal_box_printed':
