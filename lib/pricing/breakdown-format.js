...
export function formatPizzaBoxBreakdown(result, params = {}) {
  ...
  lines.push(
    materialLine('Plain box', b.plain_unit_cost_ex, goodsLineInc(b.plain_unit_cost_ex, docType), docType),
...
export function formatPlainPackagingBreakdown(result, params = {}) {
  ...
  return [
    ...
    materialLine('Plain unit', b.plain_unit_cost_ex, goodsLineInc(b.plain_unit_cost_ex, docType), docType),
