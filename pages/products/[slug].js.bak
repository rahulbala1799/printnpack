  ...
  return (
    <Layout>
      ...
      {product && product.id === 'vinyl-stickers' && (
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-800 to-indigo-900 border-b border-gray-200 pb-10">
          ...
          <div className="container mx-auto px-4 py-8 md:py-16 relative z-10">
            {/* Mobile image display - top position */}
            <div className="md:hidden mb-8">
              <div className="relative h-80 rounded-xl overflow-hidden shadow-2xl mx-auto max-w-sm">
                ...
                <div className="absolute bottom-4 left-0 right-0 text-center">
                  <span className="inline-block bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                    Premium Quality
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {/* Desktop image display - normal grid position */}
              <div className="relative hidden md:block">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition duration-500 h-48 relative">
                      <Image 
                        src="/ifa/product/vinylstk/vinyl-decal-1000x1000.webp"
                  ...
                  <div className="space-y-4 mt-8">
                    ...
                    <div className="rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition duration-500 h-48 relative">
                      <Image 
                        src="/ifa/product/vinylstk/custom-printed-decals-1000x1000.webp"
                        alt="Custom shape print decals" 
                        fill 
                        className="object-cover hover:opacity-90"
                        sizes="(max-width: 768px) 100vw, 50vw"
                      />
      ...
      {/* Enhanced Premium Vinyl Solutions section for vinyl stickers */}
      {product && product.id === 'vinyl-stickers' && (
        <div className="py-16 bg-gradient-to-br from-white to-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-3 text-gray-900 relative inline-block">
                Premium Vinyl Solutions
                <div className="absolute -top-6 -right-8 w-12 h-12 animate-pulse">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto my-4 rounded-full"></div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Left Column - Custom Vinyl Stickers */}
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-xl transform transition-all duration-500 hover:scale-[1.02] group">
                ...
                <div className="relative p-8 md:p-10 h-full flex flex-col z-30">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4">Custom Vinyl Stickers</h3>
                  <p className="text-lg text-blue-100 mb-6">
                    High-quality vinyl stickers and decals for business branding, promotions, and creative applications in any size or shape.
                  </p>
                  
                  <div className="mt-2 mb-6">
                    <p className="text-xl font-medium italic text-white mb-3">
                      "Transform your ideas into eye-catching stickers cut into virtually any shape imaginable."
                    </p>
                  </div>
                  
                  {/* Image with overlay */}
                  <div className="mt-auto mb-4 relative overflow-hidden rounded-xl shadow-lg h-60 transform transition-all duration-700 group-hover:scale-105">
                    <Image 
                      src="/ifa/product/vinylstk/Window_Sticker_3_01042303202404.png.webp"
                      alt="Custom vinyl sticker application" 
                      fill 
                      className="object-cover"
                    />
                  ...
                  <div className="flex justify-center">
                    <a href="#request-quote" className="bg-white text-blue-800 px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-blue-50 transition transform hover:-translate-y-1 flex items-center gap-2">
                ...
                {/* Flashing corner */}
                <div className="absolute -top-10 -right-10 w-20 h-20 bg-yellow-400 rotate-45 transform -translate-y-1/2 animate-pulse"></div>
              </div>
              
              {/* Right Column - Features Grid */}
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition flex flex-col">
                  <div className="bg-blue-100 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                  </div>
                  <h4 className="text-lg font-bold mb-2 text-gray-900">Indoor & Outdoor</h4>
                  <p className="text-gray-600 text-sm">Durable options for both indoor displays and outdoor applications with UV protection.</p>
                  
                  <div className="mt-auto pt-4">
                    <div className="relative h-32 rounded-lg overflow-hidden">
                      <Image 
                        src="/ifa/product/vinylstk/custom-printed-decals-1000x1000.webp"
                        alt="Indoor and outdoor vinyl applications" 
                        fill 
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition flex flex-col">
                  ...
                  <h4 className="text-lg font-bold mb-2 text-gray-900">Custom Finishes</h4>
                  <p className="text-gray-600 text-sm">Choose from glossy, matte, metallic, or transparent finishes for unique visual effects.</p>
                  
                  <div className="mt-auto pt-4">
                    <div className="relative h-32 rounded-lg overflow-hidden">
                      <Image 
                        src="/ifa/product/vinylstk/Transperent_Sticker_low_03281303202404.png.webp"
                        alt="Custom vinyl finishes" 
                        fill 
                        className="object-cover hover:scale-110 transition duration-700"
                      />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition flex flex-col">
                  ...
                  <h4 className="text-lg font-bold mb-2 text-gray-900">Precision Cutting</h4>
                  <p className="text-gray-600 text-sm">Advanced contour cutting technology for any custom shape or intricate design.</p>
                  
                  <div className="mt-auto pt-4">
                    <div className="relative h-32 rounded-lg overflow-hidden">
                      <Image 
                        src="/ifa/product/vinylstk/Vinyl-Decals-_-Stickers.jpg"
                        alt="Precision cut vinyl stickers" 
                        fill 
                        className="object-cover hover:scale-110 transition duration-700"
                      />
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition flex flex-col">
                  ...
                  <h4 className="text-lg font-bold mb-2 text-gray-900">Various Sizes</h4>
                  <p className="text-gray-600 text-sm">From small labels (20mm) to large format stickers up to 1.5m width for any project.</p>
