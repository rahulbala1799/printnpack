...
const ProductDetail = ({ product, relatedProducts }) => {
  ...
  return (
    <Layout>
          ...
          <div className="container mx-auto px-4 py-8 md:py-16 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="text-white order-2 md:order-1">
                <span className="inline-block bg-white/20 backdrop-blur-sm text-white px-4 py-1 rounded-full text-sm font-medium mb-4 md:mb-6">
                  {product.category}
                </span>
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight">
                  Eco-Friendly <span className="text-yellow-300">Pizza Boxes</span><br className="hidden sm:block" /> With Style
                </h1>
                <p className="text-lg md:text-xl text-amber-100 mb-6 md:mb-8 max-w-lg">
                ...
                <div className="mt-6 md:mt-10">
                  <span className="text-sm text-amber-200 block mb-2 md:inline md:mr-3">Available sizes: </span>
                ...
                <div className="relative aspect-square max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl mx-auto">
                  {product.images.map((img, idx) => (
                    ...
                    >
                      ...
                      {/* Decorative elements */}
                      <div className="absolute -top-3 -right-3 md:-top-6 md:-right-6 w-8 h-8 md:w-12 md:h-12 bg-orange-500 rounded-full opacity-80 animate-pulse"></div>
                      <div className="absolute -bottom-2 -left-2 md:-bottom-3 md:-left-3 w-6 h-6 md:w-8 md:h-8 bg-yellow-400 rounded-full opacity-70 animate-bounce"></div>
      ...
      {/* Custom section for Paper Bags */}
      {product && (product.id === 'flat-handle-paper-bags' || product.id === 'twisted-handle-paper-bags') && (
        <div className="bg-gradient-to-b from-blue-50 to-white py-10 border-b border-gray-200 shadow-sm">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">
                  Premium Quality Paper Bags in Three Perfect Sizes
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Our {product.id === 'flat-handle-paper-bags' ? 'flat handle' : 'twisted handle'} paper bags are available in three convenient sizes to suit all your packaging needs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-gray-200">
                  <div className="h-48 bg-gray-100 flex items-center justify-center p-4">
                    <div className="relative w-32 h-40 bg-blue-100 rounded">
                      <div className="absolute inset-x-0 top-0 h-2 bg-blue-600 rounded-t"></div>
                      <div className="absolute inset-x-0 top-2 h-6 bg-white flex items-center justify-center">
                        <span className="text-xs font-medium text-blue-800">SMALL</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-4">
                    <h3 className="font-bold text-lg text-blue-900 mb-2">Small Size</h3>
                    <p className="text-gray-700 mb-3">{product.id === 'flat-handle-paper-bags' ? '8"×5"×10"' : '8"×4.5"×10"'}</p>
                    <p className="text-sm text-gray-600">Perfect for small items, accessories, gifts, and boutique purchases.</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-gray-200">
                  <div className="h-48 bg-gray-100 flex items-center justify-center p-4">
                    <div className="relative w-36 h-44 bg-blue-100 rounded">
                      <div className="absolute inset-x-0 top-0 h-2 bg-blue-600 rounded-t"></div>
                      <div className="absolute inset-x-0 top-2 h-6 bg-white flex items-center justify-center">
                        <span className="text-xs font-medium text-blue-800">MEDIUM</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-4">
                    <h3 className="font-bold text-lg text-blue-900 mb-2">Medium Size</h3>
                    <p className="text-gray-700 mb-3">{product.id === 'flat-handle-paper-bags' ? '10"×6"×12"' : '10"×5"×13"'}</p>
                    <p className="text-sm text-gray-600">Our most popular size for retail items, clothing, and general merchandise.</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-gray-200">
                  <div className="h-48 bg-gray-100 flex items-center justify-center p-4">
                    <div className="relative w-40 h-48 bg-blue-100 rounded">
                      <div className="absolute inset-x-0 top-0 h-2 bg-blue-600 rounded-t"></div>
                      <div className="absolute inset-x-0 top-2 h-6 bg-white flex items-center justify-center">
                        <span className="text-xs font-medium text-blue-800">LARGE</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-4">
                    <h3 className="font-bold text-lg text-blue-900 mb-2">Large Size</h3>
                    <p className="text-gray-700 mb-3">{product.id === 'flat-handle-paper-bags' ? '12"×7"×14"' : '12"×6"×15.5"'}</p>
                    <p className="text-sm text-gray-600">Ideal for larger purchases, multiple items, and premium products.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200">
                <div className="md:flex">
                  <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 text-white p-8 flex items-center">
                    <div>
                      <h3 className="text-2xl font-bold mb-4">Advanced Digital Printing Technology</h3>
                      <p className="mb-6">Our state-of-the-art digital CMYK printing delivers exceptional quality without the expense of traditional printing methods.</p>
                      <ul className="space-y-3">
                        <li className="flex items-start">
                          <svg className="w-5 h-5 text-blue-200 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>No expensive printing plates or setup costs</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="w-5 h-5 text-blue-200 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>Unlimited color options with exceptional accuracy</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="w-5 h-5 text-blue-200 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>Fine detail reproduction for complex designs</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="w-5 h-5 text-blue-200 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>Perfect for both simple logos and complex graphics</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="md:w-1/2 p-8">
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">Transparent Cost Structure</h3>
                    <p className="text-gray-600 mb-6">
                      Our pricing is based solely on ink coverage and design complexity, with no hidden fees or minimum charges.
                    </p>
                    <div className="space-y-4">
                      <div className="border-l-4 border-blue-500 pl-4 py-2">
                        <h4 className="font-semibold text-gray-800">Simple Designs</h4>
                        <p className="text-sm text-gray-600">Small logos and simple graphics use less ink and cost less.</p>
                      </div>
                      <div className="border-l-4 border-blue-500 pl-4 py-2">
                        <h4 className="font-semibold text-gray-800">Medium Complexity</h4>
                        <p className="text-sm text-gray-600">Average designs with moderate ink coverage at standard rates.</p>
                      </div>
                      <div className="border-l-4 border-blue-500 pl-4 py-2">
                        <h4 className="font-semibold text-gray-800">Complex Designs</h4>
                        <p className="text-sm text-gray-600">Elaborate, colorful designs with high ink coverage cost more but deliver maximum impact.</p>
                      </div>
                    </div>
                  </div>
                </div>
