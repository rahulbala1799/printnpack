          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/3 bg-gradient-to-b from-blue-800 to-blue-900 p-8 text-white">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <FaEnvelope className="text-blue-300 mr-4 mt-1 text-xl" />
                  <div>
                ...
                <div className="flex items-start">
                  <FaHeadset className="text-blue-300 mr-4 mt-1 text-xl" />
                  <div>
              ...
              {formSubmitted ? (
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="productInterest" className="block text-sm font-medium text-gray-700 mb-1">What can we help you with?</label>
                      <select
                        id="productInterest"
